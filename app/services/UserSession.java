...
public class UserSession {
	...
	public static void saveSessionToken(String userId, String token,String ip) {
	...
	public static Boolean extendSession(String token) {
		...
		String query = "update login_session set expire_at = DATE_ADD(NOW(), INTERVAL 180 SECOND)"+
	...
	public static boolean invalidateSessionToken(String userId, String token) {
		...
		String query = "UPDATE login_session SET expired = 1 WHERE token = '"+token+"' AND user_id = '"+userId+"' ";
		SqlUpdate update = Ebean.createSqlUpdate(query);
